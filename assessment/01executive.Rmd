...
Landings and the estimated total catch for the last ten-years are shown in Table \@ref(tab:es-landings).
...
sa4ss::table_format(
  x = df,
  caption = "Landings (mt) by fleet and the summed coastwide total landings (mt) and estimated total catch (mt).",
  label = "es-landings",
  digits = 1,
  align = "l",
  # to do: use a renamer between fleet number and name
  col_names = c("Year", "Fixed Gear Landings (mt)", "Trawl Landings (mt)", "Total Landings (mt)", "Total Catch (mt)")
)
```
