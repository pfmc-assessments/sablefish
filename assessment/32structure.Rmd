...
- **Data**
  ...
  - The following data changes led to noticeable changes in the model output but should be looked at in aggregate after the model was retuned with the compositional data rather than prior to the tuning (Figures \@ref(fig:bridging-2-compare13)--\@ref(fig:bridging-2-compare3)).
