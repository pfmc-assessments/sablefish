...
- **Data**
  ...
  - The following data changes led to noticeable changes in the model output but should be looked at in aggregate after the model was re-tuned with the compositional data rather than prior to the tuning (Figures \@ref(fig:bridging-2-compare13)--\@ref(fig:bridging-2-compare3)).
    - The index for the environmental linkage was updated.
    - The survey length-composition data were input as either sexed or unsexed fish rather than assigning a sex to unsexed fish based on the observed sex ratio as was done in the past. This change led to even further increases in estimates of $R_0$ (Figures \@ref(fig:bridging-2-compare1)--\@ref(fig:bridging-2-compare3)) and the trend in abundance from the \gls{s-wcgbt} index (Figure \@ref(fig:bridging-2-compare13)).
    - The length- and age-composition data present in the model were updated and data from the most recent years were included.
    - Information on mean body weight of the discarded fish were updated and data from the most recent years were included.
    - Information on discard rates from the most recent years were included and the input variance for these two most recent years in the trawl fleet was set to 0.05.
...
Fixing the retention and selectivity parameters at their bounds led to almost no changes in the model output (Figures \@ref(fig:bridging-3-compare13)--\@ref(fig:bridging-3-compare3)).
