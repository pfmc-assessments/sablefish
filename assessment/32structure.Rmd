...
The following likelihood components are included in this model: `r text_likelihoods_used(model)` (Table \@ref(tab:likes)). See the \gls{ss3} technical documentation for details on each component [@methot_stock_2013].
