...
sa4ss::add_figure(
  ...
  alt_caption = "See Table \\@ref(tab:landings) for the time series shown in this figure.",
  label = "data-landings"
)
```
...
sa4ss::add_figure(
  ...
  caption = glue::glue("The proportion of tows that observe {spp} out of all tows performed within a given range of latitudes (decimal degress) in the \\glsentrylong{{s-wcgbt}}."),
...
sa4ss::add_figure(
  ...
  caption = "Time series of \\glsentrylong{spr} (SPR) ratio: (1-SPR)/(1-SPR 45%).",
  alt_caption = "",
  label = "model-spr"
)
