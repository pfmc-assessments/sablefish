...
tab[,1] <- c(
                   ...
                   "Prior Likelihood",
                   "Parameter Devs. Likelihood",
                   "R$_0$", "SB$_0$", "SB 2023", "Fraction Unfished 2023",
                   "Yield at SPR", "$h$", 
                   "$M$ (female)", "Lmin (female)", "Lmax (female)", "k (female)", "CV$_1$ (female)", "CV$_2$ (female)",
                   "$M$ (male)", "Lmin (male)", "Lmax (male)", "k (male)", "CV$_1$ (male)", "CV$_2$ (male)")
sa4ss::table_format(
  x = tab,
