...
\hypersetup{
  pdftitle={Status of sablefish (Anoplopoma fimbria) along the U.S. West Coast in 2023},
  pdflang=en-US,
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Status of sablefish (\emph{Anoplopoma fimbria}) along the U.S. West Coast in 2023}
\newcommand{\trYear}{2023}
\newcommand{\trMonth}{July}
\newcommand{\trAuthsLong}{truetrue}
\newcommand{\trAuthsBack}{Johnson, K.F., C.R. Wetzel}
\newcommand{\trCitation}{
...
\noindent
\begin{center}
\title{Status of sablefish (\emph{Anoplopoma fimbria}) along the U.S. West Coast in 2023}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Status of sablefish (\emph{Anoplopoma fimbria}) along the U.S. West Coast in 2023}}

\includegraphicsifexists[width=4in]{figure_title.png}
\vfill
by\\
Kelli F. Johnson\textsuperscript{1}\\
...
This assessment reports the status of sablefish (\emph{Anoplopoma fimbria}) off the U.S. West Coast coast using data through xxxx.
...
The \gls{s-aslope} operated during the months of October to November aboard the F\slash V \emph{Half Moon} in 1984, September to October aboard the F\slash V \emph{Golden Fleece} in 1989, and October to November aboard the R\slash V \emph{Miller Freeman} in all other years. Partial coverage of the U.S. West Coast occurred during the years 1984 and 1988--1996 and complete coverage (i.e., north of 34\textdegree 30\textquotesingle S) during the years 1997 and 1999--2001. Typically, only these latter four years are included in assessments.
