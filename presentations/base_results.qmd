...
-    NWFSC WCGBTS Index
-    Length
-    Marginal Age (unchanged)
-    Conditional Age-at-Length

## Fits to the Data - Env. Index
...
## Model Diagnostics - Sensitivity 1

![](../models/2023/DiscardVariance/sensitivities/1-compare2_spawnbio_uncertainty.png){fig-align="center"}

## Model Diagnostics - Sensitivity 1

![](../models/2023/DiscardVariance/sensitivities/1-compare4_Bratio_uncertainty.png){fig-align="center"}

## Model Diagnostics - Sensitivity 2

![](../models/2023/DiscardVariance/sensitivities/2-compare2_spawnbio_uncertainty.png){fig-align="center"}

## Model Diagnostics - Sensitivity 2

![](../models/2023/DiscardVariance/sensitivities/2-compare4_Bratio_uncertainty.png){fig-align="center"}

## Model Diagnostics - Sensitivity 3

![](../models/2023/DiscardVariance/sensitivities/3-compare2_spawnbio_uncertainty.png){fig-align="center"}

## Model Diagnostics - Sensitivity 3

![](../models/2023/DiscardVariance/sensitivities/3-compare4_Bratio_uncertainty.png){fig-align="center"}
...
## Projection Results {.smaller .scrollable}
